...
public class Stone extends GameWorldCharacter {

	public Stone(TextureRegion firstFrame, BoxWorld bw, float x, float y) {
		super(firstFrame, bw, x, y);
		
		name = "Stone";
		
		this.downAnim = new GameAnimation(0.2f, new TextureRegion[]{
				ImageCache.getFrame("stone", 1), 
				});
		...
		facePicture = ImageCache.getTexture("stone_1");
	}
}
